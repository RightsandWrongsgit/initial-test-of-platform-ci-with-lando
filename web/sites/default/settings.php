...
//      $config['config_split.config_split.local']['status'] = TRUE;
  // Environment indicator case 'default to sync', white text on purple:
  //$config['environment_indicator.indicator']['bg_color'] = '#BF40BF';
  //$config['environment_indicator.indicator']['fg_color'] = '#ffffff';
  //$config['environment_indicator.indicator']['name'] = 'default to sync';
//}
//}
